...
def train(train_loader, dev_loader, model, optimizer, scheduler, model_dir, device, model_name):
    ...
    for epoch in range(1, epoch_num + 1):
        ...
        if improve_f1 > 1e-5:
            best_val_f1 = val_f1
            final_model_save_path = os.path.join(model_dir, 'best_PKU_' + model_name + '.pt')
...
def train_model(dataset_path, save_model_path, load_model_path, model_name):
    ...
    train(train_loader, dev_loader, model, optimizer, scheduler, save_model_path, device, model_name)
