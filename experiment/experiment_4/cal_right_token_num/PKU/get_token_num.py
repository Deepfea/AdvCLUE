...
def cal_ASR(model_name, dataset_name, base_adv_path, base_model_path, base_tokenizer_path):
    ...
    # print(train_dataset.dataset[0][0][0][0])
    ...
    # print(results)
    get_token(results, train_dataset)

def get_token(result, test_dataset):
    token_list = []
    for num in range(len(test_dataset.dataset)):
        if result[num] == 0 or result[num] == False:
            # print(num)
            continue
        temp_list = test_dataset.dataset[num][0][0][0]

        # print(test_dataset.dataset[num][0][0])
        # print(token_list)
