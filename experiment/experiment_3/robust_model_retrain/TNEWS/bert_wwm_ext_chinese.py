...
model_name = 'bert_wwm_ext_chinese'
dataset_name = 'TNEWS'
...
def get_adv(dataset_path, adv_path):
...
def main():
    save_path = os.path.join('/media/usr/external/home/usr/project/project3_data/experiment/experiment2/AdvCLUE/retrained_model/TNEWS')
    dataset_path = '/media/usr/external/home/usr/project/project3_data/dataset/TNEWS'
    adv_path = '/media/usr/external/home/usr/project/project3_data/adv_samples/TNEWS/final_adv'
    train_data = get_adv(dataset_path, adv_path)
