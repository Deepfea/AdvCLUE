...
def load_adv_data(dataset_name, base_adv_path):
    ...
    candidates = np.load(os.path.join(data_path, 'train_candidates.npy'), allow_pickle=True)
    candidate_ids = np.load(os.path.join(data_path, 'train_candidate_ids.npy'), allow_pickle=True)
