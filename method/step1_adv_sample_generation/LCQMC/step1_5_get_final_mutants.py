    ...
    for name_num in range(len(mutant_candidate_list)):
        ...
        for data_num in tqdm(range(len(test_data_label))):
            if int(test_data_label[data_num]) != int(pre_label_1[data_num]):
                ...
                ori_text_a_list.append(candidates_1.loc[data_num, 'ori_text_a'])
                ori_text_b_list.append(candidates_1.loc[data_num, 'ori_text_b'])
                text_a_list.append(candidates_1.loc[data_num, 'text_a'])
                text_b_list.append(candidates_1.loc[data_num, 'text_b'])
            ...
            if int(test_data_label[data_num]) != int(pre_label_2[data_num]):
                belong_list.append(data_num)
                ori_text_a_list.append(candidates_2.loc[data_num, 'ori_text_a'])
                ori_text_b_list.append(candidates_2.loc[data_num, 'ori_text_b'])
                text_a_list.append(candidates_2.loc[data_num, 'text_a'])
                text_b_list.append(candidates_2.loc[data_num, 'text_b'])
            ...
            if int(test_data_label[data_num]) != int(pre_label_3[data_num]):
                belong_list.append(data_num)
                ori_text_a_list.append(candidates_3.loc[data_num, 'ori_text_a'])
                ori_text_b_list.append(candidates_3.loc[data_num, 'ori_text_b'])
                text_a_list.append(candidates_3.loc[data_num, 'text_a'])
                text_b_list.append(candidates_3.loc[data_num, 'text_b'])
        ...
        merge_dt_dict = {'belong': belong_list, 'ori_text_a': ori_text_a_list, 'ori_text_b': ori_text_b_list,
                         'text_a': text_a_list, 'text_b': text_b_list, 'str': str_list, 'word': word_list,
