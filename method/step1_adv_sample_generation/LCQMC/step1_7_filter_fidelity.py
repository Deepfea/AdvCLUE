...
def get_fidelity_mutants(load_path):
    ...
    for name_num in range(len(final_mutants_list)):
        ...
        ori_text_a = list(candidate_mutants['ori_text_a'])
        ori_text_b = list(candidate_mutants['ori_text_b'])
        text_a = list(candidate_mutants['text_a'])
        text_b = list(candidate_mutants['text_b'])
        ...
        merge_dt_dict = {'belong': belong_list, 'ori_text_a': ori_text_a_list, 'ori_text_b': ori_text_b_list, 'text_a': text_a_list,
                         'text_b': text_b_list, 'str': str_list, 'word': word_list, 'label': label_list,
                         'type': mut_list}
