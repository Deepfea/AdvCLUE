...
def main():
    save_path = os.path.join('/media/usr/external/home/usr/project/project3_data/adv_samples', dataset_name, 'final_adv')
    ...
    # if not os.path.exists(model_save_path):
    #     os.makedirs(model_save_path)
    # final_model_save_path = os.path.join(model_save_path, 'final_' + dataset_name + '_' + model_name + '.pt')
    # torch.save(model, final_model_save_path)
