...
def get_fidelity_mutants(load_path):
    ...
    for name_num in range(len(final_mutants_list)):
        ...
        ori_text_a = list(candidate_mutants['ori_premise'])
        ori_text_b = list(candidate_mutants['ori_hypothese'])
        text_a = list(candidate_mutants['premise'])
        text_b = list(candidate_mutants['hypothese'])
