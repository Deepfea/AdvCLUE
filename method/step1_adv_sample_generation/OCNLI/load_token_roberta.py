...
def load_token(data):
    vocab_path = '/media/usr/external/home/usr/project/project3_data/base_model/roberta_base_chinese/vocab.txt'
    ...
    for num in range(len(data)):
        tokens = []
        token_type_ids = []
        text_a = data.loc[num, 'premise']
        text_b = data.loc[num, 'hypothese']
