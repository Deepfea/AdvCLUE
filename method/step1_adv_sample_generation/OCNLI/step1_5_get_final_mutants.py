    ...
    for name_num in range(len(mutant_candidate_list)):
        ...
        for data_num in tqdm(range(len(test_data_label))):
            if int(test_data_label[data_num]) != int(pre_label_1[data_num]):
                ...
                ori_text_a_list.append(candidates_1.loc[data_num, 'ori_premise'])
                ori_text_b_list.append(candidates_1.loc[data_num, 'ori_hypothese'])
                text_a_list.append(candidates_1.loc[data_num, 'premise'])
                text_b_list.append(candidates_1.loc[data_num, 'hypothese'])
            ...
            if int(test_data_label[data_num]) != int(pre_label_2[data_num]):
                belong_list.append(data_num)
                ori_text_a_list.append(candidates_2.loc[data_num, 'ori_premise'])
                ori_text_b_list.append(candidates_2.loc[data_num, 'ori_hypothese'])
                text_a_list.append(candidates_2.loc[data_num, 'premise'])
                text_b_list.append(candidates_2.loc[data_num, 'hypothese'])
            ...
            if int(test_data_label[data_num]) != int(pre_label_3[data_num]):
                belong_list.append(data_num)
                ori_text_a_list.append(candidates_3.loc[data_num, 'ori_premise'])
                ori_text_b_list.append(candidates_3.loc[data_num, 'ori_hypothese'])
                text_a_list.append(candidates_3.loc[data_num, 'premise'])
                text_b_list.append(candidates_3.loc[data_num, 'hypothese'])
                ...
                mut_list.append(mut_name_list[name_num])
        merge_dt_dict = {'belong': belong_list, 'ori_premise': ori_text_a_list, 'ori_hypothese': ori_text_b_list,
                         'premise': text_a_list, 'hypothese': text_b_list, 'str': str_list, 'word': word_list,
