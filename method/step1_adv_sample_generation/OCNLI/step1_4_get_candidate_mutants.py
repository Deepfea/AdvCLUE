...
from method.step1_adv_sample_generation.OCNLI.get_sentence import get_sentence
...
def save_candidate_mutants(test_data, mutant_x, mutant_y, ori_strs, mut_strs, load_rate_path, save_name):
    ...
    for data_num in range(len(test_data)):
        ...
        ori_text_a = test_data.loc[data_num, 'premise']
        ori_text_b = test_data.loc[data_num, 'hypothese']
    ...
    merge_dt_dict = {'ori_premise': ori_text_a_list, 'ori_hypothese': ori_text_b_list, 'premise': text_a_list, 'hypothese': text_b_list,
...
def get_sentences(test_data, select_words, select_word_texts, mutate_list):
    ...
    for data_num in range(len(select_words)):
        text_a = test_data.loc[data_num, 'premise']
        text_b = test_data.loc[data_num, 'hypothese']
