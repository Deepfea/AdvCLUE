...
import os
import pandas as pd
from method.step1_adv_sample_generation.CSL.seg_data_to_words import seg_data
...
def gen_new_sentence(data_path):
    ...
    for data_num in range(len(seg_arr)):
        ...
        ori_fact_a = test_data.loc[data_num, 'abs']
        ori_fact_b = test_data.loc[data_num, 'keyword']
    ...
    merge_dt_dict = {'belong': belong_list, 'belong_text': belong_text, 'str': str_list, 'abs': fact_a_list,
                     'keyword': fact_b_list, 'label': label_list}
...
class Config:
    ...
    max_length = 510
    batch_size = 16
    pretrained_dir = '/media/usr/external/home/usr/project/project3_data/dataset/CSL'
