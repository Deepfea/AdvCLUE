...
class Config:
    ...
    output_model_dir = '/media/usr/external/home/usr/project/project3_data/adv_samples/CHID/final_adv/roberta_base_chinese'
...
def train_model(dataset_path):
    ...
    train_dataset = convert_to_features(df_train, train_candidates, train_candidate_ids)
    ...
    valid_dataset = convert_to_features(df_dev, test_candidates, test_candidate_ids)
