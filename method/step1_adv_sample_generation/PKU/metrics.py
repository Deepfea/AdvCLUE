...
def bad_case(sents, preds, tags):
    case_dir = '/media/usr/external/home/usr/project/project3_data/adv_samples/UPK/bad_case.txt'
    if not os.path.exists(case_dir):
        os.system(r"touch {}".format(case_dir))  # 调用系统命令行来创建文件
    output = open(case_dir, 'w')
...
def output_write(sents, preds):
    ...
    output_dir = '/media/usr/external/home/usr/project/project3_data/adv_samples/PKU/output.txt'
...
def output2res():
    ...
    res_dir = '/media/usr/external/home/usr/project/project3_data/adv_samples/PKU/res.txt'
