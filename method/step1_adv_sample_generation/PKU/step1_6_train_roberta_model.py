...
def train(train_loader, dev_loader, model, optimizer, scheduler, model_dir, device):
    ...
    for epoch in range(1, epoch_num + 1):
        ...
        if improve_f1 > 1e-5:
            best_val_f1 = val_f1
            final_model_save_path = os.path.join(model_dir, 'best_PKU_roberta_base_chinese_.pt')
...
def train_model(dataset_path, model_path):
    ...
    bert_model = '/media/usr/external/home/usr/project/project3_data/base_model/roberta_base_chinese'
    label2id = {'B': 0, 'M': 1, 'E': 2, 'S': 3}
