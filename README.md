...
We propose AdvCLUE on the datasets of single sentence tasks, sentence pair tasks, and machine reading comprehension tasks.

**Single sentence tasks** are the fundamental datasets in NLU. Such datasets contain sentences with simple and clear semantic information. They evaluate whether models can process and understand individual sentences without considering the relationships or contextual information between sentences. The selected datasets are shown as follows:
